<?php
	$queryApproved = 0;
	foreach($queryAllWebsites->result_array() as $myarraycontent){
...
?>
	...
	<div class="container-fluid">
		...
		<caption>
			<span> Total No. of Websites: <strong><?php echo $queryAllWebsites->num_rows(); ?></strong> </span><br>
		...
		<thead>
			<tr>
				<th data-order="id"> # </th>
				<th data-order="user_id"> user </th>
				<th data-order="site_name"> name </th>
				<th data-order="business_type"> business type </th>
				...
				<th data-order="deleted"> deleted </th>
